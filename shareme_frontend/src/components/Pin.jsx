      ...
      >
        ...
        {postHovered && (
          <div
            ...
            style={{ height: '100%' }} //tailwindCSS giving issues with h-full so we need to set it manually here
          >
            <div className="flex items-center justify-between">
              <div className='flex gap-2'>
                <a
                  href={`${image?.asset?.url}?dl=`} //allow download of image
                  download
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              ...
              {destination && (
                ...
                >
                  ...
                  {destination.length > 20 ? destination.slice() : destination.slice(8)}*/}
